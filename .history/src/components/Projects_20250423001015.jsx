...
export default function Projects() {
  ...
  const projects = [
    {
      id: 1,
      title: "Recipe Generator And Meal Planner",
      description:
        "A comprehensive application that generates personalized recipes based on dietary preferences and creates weekly meal plans with automated shopping lists.",
      image: "/placeholder.svg?height=600&width=800",
      tags: ["React", "Node.js", "MongoDB", "Natural Language Processing"],
    ...
    },
    {
      ...
      description: "A scalable task management platform designed for enterprise teams with real-time collaboration features, analytics dashboard, and seamless workflow automation.",
      image: "/placeholder.svg?height=600&width=800",
    ...
    },
    {
      ...
      description: "An interactive data visualization platform providing comprehensive climate insights with historical trends and predictive modeling for environmental research.",
      image: "/placeholder.svg?height=600&width=800",
      tags: ["React", "D3.js", "REST APIs", "Data Visualization"],
      demoLink: "https://example.com",
      githubLink: "https://github.com/yourusername/project",
    },
    {
    ...
    },
    {
      ...
      description: "A comprehensive wellness application with personalized fitness tracking, nutrition monitoring, and wellness analytics built with a focus on user privacy.",
      image: "/placeholder.svg?height=600&width=800",
      tags: ["React Native", "AWS", "Python", "Health APIs"],
      demoLink: "https://example.com",
      githubLink: "https://github.com/yourusername/project",
    },
  ]
