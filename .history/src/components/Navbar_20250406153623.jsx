...
const Navbar = ({ scrollToSection }) => {
  ...
  return (
    <nav className="bg-[#0F172A]/80 backdrop-blur-md text-[#F8FAFC] fixed w-full z-50">
      ...
      {isOpen && (
        <div className="md:hidden fixed inset-0 bg-[#0F172A] bg-opacity-95 backdrop-blur-md z-40 flex flex-col items-center justify-center space-y-8 text-2xl transition-all duration-300 ease-in-out">
