        ...
        <div className="w-full md:w-64 bg-[#252526] border-r border-gray-800 md:h-full h-48 overflow-y-auto">
          ...
          {skillCategories.map((category) => (
            <div key={category.name} className="px-2">
              <div
                className="flex items-center py-1 cursor-pointer hover:bg-[#2a2d2e] rounded px-1 transition-colors duration-200"
                ...
                <div className="ml-6">
                  {category.skills.map((skill) => (
                    <div
                      ...
                      className={clsx(
                        "flex items-center py-1 cursor-pointer hover:bg-[#2a2d2e] rounded px-1 transition-colors duration-200",
