...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-screen flex flex-col items-center justify-center bg-gray-100 overflow-hidden px-4 sm:px-6">
      {/* Particle Background */}
      <div className="absolute inset-0">
        <ParticlesBg 
          type="cobweb" 
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl">
        {/* Left Side Text */}
        <div className="w-full md:w-1/2 max-w-lg text-center md:text-left mb-10 md:mb-0">
          ...
          <button
            ...
            className="mt-4 px-6 py-2 flex items-center justify-center bg-[#0F172A]/80 backdrop-blur-2xl text-white rounded-full shadow-lg hover:bg-gray-500 transition mx-auto md:mx-0"
          >
            About Me
            <img src={downArrow} className="w-6 h-6 ml-2 brightness-0 invert animate-bounce" alt="down arrow" />
          </button>
          ...
          <section className="socials-section mt-6">
            <ul className="flex flex-wrap justify-center md:justify-start gap-4">
              <li>
                <a href="https://www.linkedin.com/in/vishwaa-bhavsar" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/linkedin.png" className="w-9 h-9 hover:opacity-70 transition duration-300" alt="LinkedIn" />
                </a>
              </li>
              <li>
                <a href="https://github.com/VishwaaBhavsar" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/github.png" className="w-10 h-10 hover:opacity-70 transition duration-300" alt="GitHub" />
                </a>
              </li>
              <li>
                <a href="https://x.com/Vishwaa_Bhavsar" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/X.png" className="w-11 h-11 hover:opacity-70 transition duration-300" alt="X" />
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="mailto:vishwaa0606@gmail.com" target="_blank" rel="noopener noreferrer">
                  <img src="/assets/mail.png" className="w-10 h-10 hover:opacity-70 transition duration-300" alt="Email" />
                </a>
              </li>
            </ul>
          </section>
        ...
        <div className="flex justify-center md:justify-end w-full md:w-1/2">
          <div
            className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-60 md:h-60 cursor-pointer"
            onMouseEnter={handleHover}
          >
            {isFlipped && (
              <motion.div
