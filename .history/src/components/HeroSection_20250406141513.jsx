...
//       {/* Main Content */}
//       <div className="relative z-10 flex flex-col md:flex-row items-center gap-60 text-center md:text-left px-20">
//         {/* Left Side Text */}
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl px-6 md:px-20">
        ...
        <div className="w-full md:w-1/2 max-w-lg mb-10 md:mb-0">
          ...
          <button
            ...
            className="mt-7 px-6 py-2 bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition"
          >
            About Me ⬇
          </button>
        </div>
