...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-gray-100 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-center gap-10 text-center md:text-left px-6">
        {/* Left Side Text */}
        ...
        <div
          className="relative w-48 h-48 md:w-60 md:h-56 cursor-pointer"
