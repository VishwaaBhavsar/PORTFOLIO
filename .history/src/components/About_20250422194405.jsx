    ...
    <div>
      ...
      <section className="py-16 px-4 md:px-16 max-w-6xl mx-auto">
        <div className="flex items-center mb-10">
          <div className="bg-gray-800 h-10 w-10 rounded-full flex items-center justify-center mr-4">
            <span className="text-white text-xl">👤</span>
          </div>
          <h1 className="text-3xl font-bold">About <span className="text-purple-600">Me</span></h1>
        </div>
