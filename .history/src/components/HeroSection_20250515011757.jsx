...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 overflow-hidden py-16 px-4">
      {/* Particle Background */}
      <div className="absolute inset-0">
        <ParticlesBg 
          type="cobweb" 
      ...
      <div className="relative z-10 flex flex-col items-center justify-between w-full max-w-6xl">
        {/* Avatar for mobile - shown at top on mobile */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
          {/* Left Side Text - Adjusted for mobile */}
          <div className="w-full md:w-1/2 max-w-lg text-center md:text-left mb-10 md:mb-0">
            ...
            <div className="flex justify-center md:justify-start">
              <button
                ...
                className="mt-4 px-6 flex flex-row py-2 bg-[#0F172A]/80 backdrop-blur-2xl text-white rounded-full shadow-lg hover:bg-gray-500 transition"
              >
                About Me 
                <img 
                  src={downArrow}
            ...
            {/* Social Icons Section */}
            <section className="socials-section mt-6">
              <ul className="social-icons flex justify-center md:justify-start gap-4">
                <li>
                  <a 
                    href="https://www.linkedin.com/in/vishwaa-bhavsar" 
                    target="_blank" 
                    ...
                    aria-label="LinkedIn"
                  >
                    <img src="/assets/linkedin.png" alt="LinkedIn" className="w-9 h-9 hover:opacity-70 transition duration-300" />
                  </a>
                </li> 
                <li>
                  <a 
                    ...
                    aria-label="GitHub"
                  >
                    <img src="/assets/github.png" alt="GitHub" className="w-10 h-10 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
                <li>
                  <a 
                  ...
                  >
                    <img src="/assets/X.png" alt="Twitter/X" className="w-11 h-11 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
                <li>
                  <a 
                    ...
                    aria-label="Email"
                  >
                    <img src="/assets/mail.png" alt="Email" className="w-10 h-10 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
              </ul>
            </section>
