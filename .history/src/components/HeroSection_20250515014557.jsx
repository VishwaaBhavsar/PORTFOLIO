...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 overflow-hidden py-10 sm:py-16">
      {/* Particle Background */}
      <div className="absolute inset-0">
        <ParticlesBg 
          type="cobweb" 
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center px-4 sm:px-6 md:px-10 lg:px-16 w-full max-w-6xl mx-auto">
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-3/5 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-black mt-2">
              I'm <span className="text-orange-500">Vishwaa Bhavsar</span>
            </h1>
            <div className="h-16 sm:h-20 mt-3"> {/* Responsive height container for typewriter */}
              <h3 className="text-xl sm:text-2xl text-gray-700">
                <Typewriter
                  options={{
                    strings: [
                      "Peeking into my world of ideas?",
            ...
            <button
              ...
              className="mt-4 px-6 flex flex-row py-2 bg-[#0F172A]/80 backdrop-blur-2xl mx-auto lg:mx-0 text-white rounded-full shadow-lg hover:bg-gray-500 transition"
            >
              About Me 
              <img 
                src={downArrow}
            ...
            {/* Social Icons Section */}
            <section className="socials-section mt-6 flex justify-center lg:justify-start">
              <ul className="social-icons flex gap-4">
                <li>
                  <a 
                    href="https://www.linkedin.com/in/vishwaa-bhavsar" 
                  ...
                  >
                    <img src="/assets/linkedin.png" alt="LinkedIn" className="w-8 h-8 sm:w-9 sm:h-9 hover:opacity-70 transition duration-300" />
                  </a>
                </li> 
                <li>
                  <a 
                  ...
                  >
                    <img src="/assets/github.png" alt="GitHub" className="w-9 h-9 sm:w-10 sm:h-10 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
                <li>
                  <a 
                  ...
                  >
                    <img src="/assets/X.png" alt="X/Twitter" className="w-10 h-10 sm:w-11 sm:h-11 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
                <li>
                  <a 
                    ...
                    aria-label="Email"
                  >
                    <img src="/assets/mail.png" alt="Email" className="w-9 h-9 sm:w-10 sm:h-10 -ml-1 sm:-ml-2 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
              </ul>
            </section>
          ...
          <div className="flex justify-center w-full lg:w-2/5 mt-8 lg:mt-0">
            <div
              className="relative w-40 h-40 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-60 lg:h-60 cursor-pointer"
              onMouseEnter={handleHover}
            >
              {/* Speech Bubble */}
              {isFlipped && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute top-[-2rem] sm:top-[-2.5rem] left-1/2 transform -translate-x-1/2 bg-white text-black text-xs sm:text-sm px-3 sm:px-4 py-1 sm:py-2 rounded-lg shadow-lg"
                >
                  {message}
                </motion.div>
              )}
