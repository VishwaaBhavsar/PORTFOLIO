...
const Navbar = ({ scrollToSection }) => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 text-white px-6 py-4 shadow-md">
      ...
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <a id="logo" className="flex items-center gap-3 logo" href="#">
          <div className=" overflow-hidden">
            <img src="src\assets\VBLogo-removebg-preview.png" className="h-12 w-12 " alt="Logo" />
          </div>
          <span
        ...
        <div
          className={`fixed inset-0 bg-black bg-opacity-80 z-40 transition-transform duration-500 ${
