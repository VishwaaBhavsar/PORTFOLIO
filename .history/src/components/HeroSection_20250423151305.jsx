...
import bitmojiImg from '../../public/assets/Bitmoji.png';
import downArrow from "../../public/assets/down.png";
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl px-6 md:px-20">
        ...
        <div className="w-full md:w-1/2 max-w-lg mb-10 md:mb-0">
          ...
          <button
            ...
            className="mt-1 px-6 flex flex-row py-2 bg-[#0F172A]/80 backdrop-blur-2xl text-white rounded-full shadow-lg hover:bg-gray-200 transition"
          >
            About Me 
          <img src={downArrow}
          ...
          <section className="socials-section mt-6">
            <ul className="social-icons flex gap-4">
              <li>
                ...
                >
                  <img src="../../public/assets/linkedin.png" className="w-9 h-9 hover:opacity-70 transition duration-300" />
              ...
              <li>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <img src="../../public/assets/github.png" className="w-10 h-10 hover:opacity-70 transition duration-300" />
              ...
              <li>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <img src="../../public/assets/X.png" className="w-11 h-11 hover:opacity-70 transition duration-300" />
              ...
              <li>
                <a 
                  ...
                  rel="noopener noreferrer"
                >
                  <img src="../../public/assets/mail.png" className="w-10 -ml-2 h-10 hover:opacity-70 transition duration-300" />
