      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between w-full max-w-6xl px-6 md:px-20">
        ...
        <div className="w-full md:w-1/2 max-w-lg mb-10 md:mb-0">
          ...
          <button
            ...
            className="mt-3 px-6 flex flex-row py-2 bg-blue-700 text-white rounded-full shadow-lg hover:bg-blue-700 transition"
          >
            About Me 
          <img src={downArrow}
          className="w-6 ml-2 mt-0.5 fill-white text-white h-6 animate-bounce"
