...
const HeroSection = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gray-100 overflow-hidden py-8 sm:py-16 px-4">
      {/* Particle Background */}
      <div className="absolute inset-0">
        <ParticlesBg 
          type="cobweb" 
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col items-center justify-between w-full max-w-6xl">
        {/* Content Container */}
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
            ...
            >
              ...
              {isFlipped && (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  exit={{ opacity: 0, y: -10 }}
                  className="absolute top-[-3rem] left-1/2 transform -translate-x-1/2 bg-white text-black text-sm px-4 py-2 rounded-lg shadow-lg"
                >
                  {message}
                </motion.div>
              )}
          ...
          <div className="w-full md:w-1/2 max-w-lg text-center md:text-left mb-6 md:mb-0">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-800">Hi There,</h2>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black mt-2">
              I'm <span className="text-orange-500">Vishwaa Bhavsar</span>
            </h1>
            <div className="h-16 sm:h-20 mt-2 sm:mt-3"> {/* Adjusted height for mobile */}
            ...
            <div className="flex justify-center md:justify-start">
              <button
                ...
                className="mt-3 sm:mt-4 px-5 sm:px-6 flex flex-row py-2 bg-[#0F172A]/80 backdrop-blur-2xl text-white rounded-full shadow-lg hover:bg-gray-500 transition"
              >
                About Me 
                <img 
                  src={downArrow}
                  className="w-5 sm:w-6 ml-2 mt-0.5 brightness-0 invert h-5 sm:h-6 animate-bounce"
                  alt="Scroll down"
                />
              </button>
            </div>
            ...
            <section className="socials-section mt-4 sm:mt-6">
              <ul className="social-icons flex justify-center md:justify-start gap-3 sm:gap-4">
                <li>
                  <a 
                    href="https://www.linkedin.com/in/vishwaa-bhavsar" 
                    target="_blank" 
                ...
                <li>
                  ...
                  >
                    <img src="/assets/X.png" alt="Twitter/X" className="w-10 h-10 sm:w-11 sm:h-11 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
                <li>
                  <a 
                    ...
                    aria-label="Email"
                  >
                    <img src="/assets/mail.png" alt="Email" className="w-9 h-9 sm:w-10 sm:h-10 hover:opacity-70 transition duration-300" />
                  </a>
                </li>
              </ul>
            </section>
