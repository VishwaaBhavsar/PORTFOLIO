...
const HeroSection = () => {
  ...
  return (
    <div className="relative h-screen flex items-center justify-center bg-gray-100 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-10 flex flex-col md:flex-row items-start gap-40 text-center md:text-left px-20">
        ...
        <div className="max-w-lg ">
          ...
          <div className="min-h-[120px] text-2xl mt-3 text-gray-700">
  <Typewriter
    options={{
      strings: [
  ...
  />
        ...
        {/* Right Side Avatar with Flip Effect */}
<div className="flex items-start justify-center min-h-[260px]">
  <div
