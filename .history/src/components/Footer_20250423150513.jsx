...
function Footer() {
  return (
    <div>
      <footer className="footer footer-horizontal footer-center bg-base-200 text-base-content rounded p-10 flex flex-col ">
        
        {/* Social Media Links */}
        <nav className="flex gap-6">
          {/* GitHub */}
          <a href="https://github.com/VishwaaBhavsar" target="_blank" rel="noopener noreferrer">
            <img src="../../public/assetsgithub.png" alt="GitHub" className="w-8 h-8 hover:opacity-70 transition duration-300" />
          </a>

          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/vishwaa-bhavsar-827907251/" target="_blank" rel="noopener noreferrer">
            <img src="../../public/assets/linkedin.png" alt="LinkedIn" className="w-7 h-7 hover:opacity-70 transition duration-300 " />
          </a>
