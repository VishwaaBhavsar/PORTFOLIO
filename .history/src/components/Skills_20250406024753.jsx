...
app.listen(3000, () => console.log("Server running on port 3000"));`,
  ...
  const currentSkill =
    skillCategories
      ...
      .find((s) => s.name === activeSkill) || skillCategories[0].skills[0];

  return (
    <div className="w-screen h-screen mx-auto border border-gray-800 rounded-md overflow-hidden shadow-xl bg-[#1e1e1e] text-gray-300 font-mono">
      {/* Header */}
