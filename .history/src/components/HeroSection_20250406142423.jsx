        ...
        <div className="w-full md:w-1/2 max-w-lg mb-10 md:mb-0">
          ...
          <section className="socials-section mt-6">
            <ul className="social-icons flex gap-4">
              <li>
                <a 
                  className="linkedin bg-blue-600 text-white p-3 rounded-full hover:bg-blue-700 transition-all flex items-center justify-center w-10 h-10"
              ...
              <li>
                <a 
                  className="github bg-gray-800 text-white p-3 rounded-full hover:bg-gray-900 transition-all flex items-center justify-center w-10 h-10" 
                  href="https://github.com/vishwaa17" 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a 
                  className="twitter bg-blue-400 text-white p-3 rounded-full hover:bg-blue-500 transition-all flex items-center justify-center w-10 h-10" 
                  href="https://twitter.com/vishwaa_bhavsar" 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a 
                  className="telegram bg-blue-500 text-white p-3 rounded-full hover:bg-blue-600 transition-all flex items-center justify-center w-10 h-10" 
                  href="https://t.me/vishwaa_bhavsar" 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
              ...
              <li>
                <a 
                  className="instagram bg-gradient-to-r from-purple-500 via-pink-500 to-orange-500 text-white p-3 rounded-full hover:opacity-90 transition-all flex items-center justify-center w-10 h-10" 
                  href="https://www.instagram.com/vishwaa.dev" 
                  target="_blank" 
                  rel="noopener noreferrer"
                >
