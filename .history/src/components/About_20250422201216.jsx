        ...
        <div className="flex flex-col md:flex-row gap-12 items-start">
          ...
          <div className="w-full md:w-2/3">
            ...
            <div className="text-black p-6 rounded-md mb-6">
              ...
              Hi, I'm Vishwaa Bhavsar, a Full-Stack Developer based in Pune, India. Currently pursuing my undergraduate degree in Information Technology at CVM University (MBIT), I’m passionate about building robust web applications that make an impact.
...
My journey in tech is all about exploring new challenges, learning from every project, and turning complex problems into elegant solutions. If you’re looking for someone who’s eager to innovate, let’s connect and create something amazing together!
            ...
            <div className="mb-4">
              <div className=" text-black px-4 py-1 rounded-md inline-block mb-3">
                <p><span className='text-gray-600'>Email:</span> jigarsable21@gmail.com</p>
              </div>
            </div>

            <div className="mb-6">
              <div className="text-black px-4  rounded-md inline-block">
                <p><span className='text-gray-600'>Place:</span> Pune, India - 412206</p>
              </div>
            </div>
